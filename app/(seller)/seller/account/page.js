  ...
  return (
    <div className="max-w-lg mx-auto pb-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative shrink-0">
            ...
            <button onClick={startEdit}
              className="absolute -bottom-1.5 -end-1.5 w-7 h-7 bg-white rounded-xl flex items-center justify-center shadow-md hover:bg-gray-50 transition-colors">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
        ...
        <SectionLabel label={t.acctMyAccountSec} />

        <MenuItem
          label={t.sellerMyProducts}
          sub={t.acctMyProductsSub}
        ...
        <button onClick={() => setShowHow(v => !v)}
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-gray-400 mt-0.5">{t.acctStepByStep}</p>
          </div>
        ...
        {showHow && (
          <div className="px-4 pb-4 space-y-3 bg-gray-50">
            {[
              { n: "1", title: t.loginStep1T, desc: t.loginStep1D },
              { n: "2", title: t.loginStep2T, desc: t.loginStep2D },
              { n: "3", title: t.loginStep3T, desc: t.loginStep3D },
              { n: "4", title: t.loginStep4T, desc: t.loginStep4D },
            ].map(s => (
        ...
        <button onClick={() => setShowFees(v => !v)}
          ...
          <div className="flex-1">
            <p className="text-sm font-semibold text-gray-800">{t.acctServiceFeesSec}</p>
        ...
        {showFees && (
          <div className="px-4 pb-4 bg-gray-50">
            ...
            <p className="text-xs text-gray-400 mt-2 text-center">{t.acctSellerFeesNote}</p>
          </div>
        )}

        <SectionLabel label={t.acctSupportSec} />
        <div className="border-t border-gray-50" />

        <MenuItem
          label={t.acctAboutTitle}
          sub={t.acctAboutMarketplace}
          onClick={() => {}}
