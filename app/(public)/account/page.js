...
export default function BuyerAccountPage() {
  ...
  const howSteps = [
    { n: "1", title: t.acctHowStep1T, desc: t.acctHowStep1D },
    { n: "2", title: t.acctHowStep2T, desc: t.acctHowStep2D },
    { n: "3", title: t.acctHowStep3T, desc: t.acctHowStep3D },
    { n: "4", title: t.acctHowStep4T, desc: t.acctHowStep4D },
  ];
  ...
  return (
    <div className="max-w-lg mx-auto pb-8">
      ...
      <div className="bg-gradient-to-br from-rose-600 via-rose-500 to-rose-400 rounded-2xl p-6 mb-2 relative overflow-hidden">
        ...
        <div dir="ltr" className="flex items-center gap-3 mb-3">
          ...
          <div>
            ...
            <p className="text-rose-200 text-xs">{t.acctAppTagline}</p>
          </div>
        </div>
        <p className="text-rose-100 text-sm leading-relaxed">{t.acctAppDesc}</p>
      </div>

      {/* ── Menu ── */}
      <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">

        <SectionLabel label={t.acctSellingSec} />
        ...
        <Link href="/seller/login" className="w-full flex items-center gap-4 px-4 py-3.5 hover:bg-gray-50 transition-colors text-start">
          ...
          <div className="flex-1">
            <p className="text-sm font-semibold text-gray-800">{t.acctStartSelling}</p>
            <p className="text-xs text-gray-400 mt-0.5">{t.acctStartSellingSub}</p>
          </div>
        ...
        <SectionLabel label={t.acctInfoSec} />
        <div className="border-t border-gray-50"/>
        ...
        <button onClick={() => setShowHow(v => !v)}
          ...
          <div className="flex-1">
            <p className="text-sm font-semibold text-gray-800">{t.acctHowItWorks}</p>
            <p className="text-xs text-gray-400 mt-0.5">{t.acctHowItWorksSub}</p>
          </div>
        ...
        <button onClick={() => setShowFees(v => !v)}
          ...
          <div className="flex-1">
            <p className="text-sm font-semibold text-gray-800">{t.acctFeesSec}</p>
            <p className="text-xs text-gray-400 mt-0.5">{t.acctFeesSub}</p>
          </div>
          ...
          <div className="px-4 pb-4 bg-gray-50">
            <div className="rounded-xl overflow-hidden border border-gray-200 mt-3">
              <div className="grid grid-cols-2 bg-gray-100 px-3 py-2">
                <p className="text-xs font-semibold text-gray-500">{t.acctFeesPriceCol}</p>
                <p className="text-xs font-semibold text-gray-500 text-end">{t.acctFeesFeeCol}</p>
              </div>
            ...
            <p className="text-xs text-gray-400 mt-2 text-center">{t.acctFeesNote}</p>
          </div>
        )}

        <SectionLabel label={t.acctAboutSec} />
        <div className="border-t border-gray-50"/>

        <MenuItem
          label={t.acctAboutTitle}
          sub={t.acctAboutSub}
          onClick={() => {}}
          iconBg="bg-gray-100"
        ...
        <div className="border-t border-gray-50"/>
        <MenuItem
          label={t.acctContactTitle}
          sub={t.acctContactSub}
      ...
      <p className="text-center text-xs text-gray-300 mt-6">{t.acctFooter}</p>
    </div>
  );
}
