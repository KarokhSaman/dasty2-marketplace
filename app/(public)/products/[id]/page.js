      ...
      <div className="grid md:grid-cols-2 gap-8">
              ...
              {photos.map((src, i) => (
                <button
                  ...
                  className={`w-16 h-16 rounded-lg overflow-hidden border-2 transition-colors ${
                    activePhoto === i ? "border-rose-500" : "border-transparent"
                  }`}
                >
        ...
        <div className="flex flex-col">
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white font-semibold py-3.5 rounded-xl transition-colors text-sm mt-auto"
          >
