    ...
    <div className="min-h-screen-dvh flex flex-col">
      ...
      {!isAddProduct && (
        ...
        <div className="flex items-center w-full py-3 px-4 pb-[max(0.75rem,env(safe-area-inset-bottom))]">
          <Link to="/" onClick={handleHomeTap} className={`flex flex-1 flex-col items-center gap-1 py-2 border-b-2 transition-all ${isHomeTab ? "border-[var(--color-ember-600)]" : "border-transparent"}`}>
