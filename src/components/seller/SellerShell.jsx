    ...
    <div className="min-h-screen-dvh flex flex-col">
      ...
      {!isAddProduct && (
        ...
        <div className="flex items-center justify-center gap-6 py-3 px-4 pb-[max(0.75rem,env(safe-area-inset-bottom))]">
          <Link to="/" onClick={handleHomeTap} className={`inline-flex flex-col items-center justify-center gap-0.5 w-12 h-12 rounded-full transition-all ${isHomeTab ? "text-[var(--color-ember-600)] bg-[var(--color-ember-50)]" : "text-[var(--color-ink-soft)] hover:text-[var(--color-ink)]"}`}>
