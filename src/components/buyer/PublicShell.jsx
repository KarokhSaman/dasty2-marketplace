      ...
      <>
        ...
        <nav className="lg:hidden fixed inset-x-0 z-30 bg-white/70 backdrop-blur-md border-t border-white/50" style={{ bottom: 0 }}>
          <div className="flex items-center w-full py-3 px-4 pb-[max(0.75rem,env(safe-area-inset-bottom))]">
            <Link to="/" onClick={handleHomeTap} className={`flex flex-1 flex-col items-center gap-1 py-2 border-2 rounded-lg transition-all ${isHome ? "border-[var(--color-ember-50)]" : "border-transparent"}`}>
            ...
            <Link to="/seller" className={`flex flex-1 flex-col items-center gap-1 py-2 border-2 rounded-lg transition-all ${isDash ? "border-[var(--color-ember-50)]" : "border-transparent"}`}>
            ...
            <Link to="/seller/account" className={`flex flex-1 flex-col items-center gap-1 py-2 border-2 rounded-lg transition-all ${isAccount ? "border-[var(--color-ember-50)]" : "border-transparent"}`}>
    ...
    <>
      ...
      <nav className="lg:hidden fixed inset-x-0 z-30 bg-white/70 backdrop-blur-md border-t border-white/50" style={{ bottom: 0 }}>
        <div className="flex items-center w-full py-3 px-4 pb-[max(0.75rem,env(safe-area-inset-bottom))]">
          ...
          <Link to="/account" className={`flex flex-1 flex-col items-center gap-1 py-2 border-2 rounded-lg transition-all ${isAccount ? "border-[var(--color-ember-50)]" : "border-transparent"}`}>
            <svg className={`w-6 h-6 transition-all ${isAccount ? "text-[var(--color-ember-600)]" : "text-[var(--color-ink-soft)]"}`} fill={isAccount ? "currentColor" : "none"} stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
            </svg>
            <span className={`text-[9px] font-semibold transition-all ${isAccount ? "text-[var(--color-ember-600)]" : "text-[var(--color-ink-soft)]"}`}>Account</span>
