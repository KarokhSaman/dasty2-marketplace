    ...
    return (
      <>
        ...
        <nav className="lg:hidden fixed inset-x-0 z-30 bg-white/70 backdrop-blur-md border-t border-white/50" style={{ bottom: 0 }}>
          <div className="flex items-center justify-center gap-6 py-3 px-4 pb-[max(0.75rem,env(safe-area-inset-bottom))]">
            <Link to="/" onClick={handleHomeTap} className={`inline-flex flex-col items-center justify-center gap-0.5 w-12 h-12 rounded-full transition-all ${isHome ? "text-[var(--color-ember-600)] bg-[var(--color-ember-50)]" : "text-[var(--color-ink-soft)] hover:text-[var(--color-ink)]"}`}>
            ...
            <Link to="/seller" className={`inline-flex flex-col items-center justify-center gap-0.5 w-12 h-12 rounded-full transition-all ${isDash ? "text-[var(--color-ember-600)] bg-[var(--color-ember-50)]" : "text-[var(--color-ink-soft)] hover:text-[var(--color-ink)]"}`}>
            ...
            <Link to="/seller/account" className={`inline-flex flex-col items-center justify-center gap-0.5 w-12 h-12 rounded-full transition-all ${isAccount ? "text-[var(--color-ember-600)] bg-[var(--color-ember-50)]" : "text-[var(--color-ink-soft)] hover:text-[var(--color-ink)]"}`}>
    ...
    <>
      ...
      <nav className="lg:hidden fixed inset-x-0 z-30 bg-white/70 backdrop-blur-md border-t border-white/50" style={{ bottom: 0 }}>
        <div className="flex items-center justify-center gap-6 py-3 px-4 pb-[max(0.75rem,env(safe-area-inset-bottom))]">
          ...
          <Link to="/account" className={`inline-flex flex-col items-center justify-center gap-0.5 w-12 h-12 rounded-full transition-all ${isAccount ? "text-[var(--color-ember-600)] bg-[var(--color-ember-50)]" : "text-[var(--color-ink-soft)] hover:text-[var(--color-ink)]"}`}>
            <svg className="w-6 h-6" fill={isAccount ? "currentColor" : "none"} stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
            </svg>
            <span className="text-[10px] font-semibold">Account</span>
