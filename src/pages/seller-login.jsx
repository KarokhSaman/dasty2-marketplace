...
export default function SellerLoginPage() {
  ...
  const stepMeta = {
    email:   { title: m.loginTitle(),       sub: m.loginSubtitle() },
    otp:     { title: m.otpLabel(),         sub: m.otpSent({ phone: email }) },
    profile: { title: m.profileStepTitle(), sub: m.profileStepSubtitle() },
  };
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-7">
            ...
            {step === "email" && (
              <form onSubmit={handleSendOtp} className="space-y-4">
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      placeholder={m.loginEmailPlaceholder()} required dir="ltr"
                ...
                <p className="text-center text-xs text-gray-400">{m.loginHasAccount()}</p>
              </form>
            )}
