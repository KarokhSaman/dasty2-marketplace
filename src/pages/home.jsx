  ...
  return (
    <div className="pb-6">
      ...
      {featuredFiltered.length > 0 && (
        <div className={`hidden xl:block sticky top-14 z-30 bg-white pt-1 pb-3 -mx-4 px-4 sm:mx-0 sm:px-0 transition-all duration-1000 ease-in-out ${animateEntrance ? "fade-up" : ""} ${isRotating ? "opacity-90 scale-[0.98]" : "opacity-100 scale-100"}`}>
      ...
      {featuredFiltered.length > 0 && (
        <div className="hidden xl:flex sticky xl:top-[265px] z-40 bg-white items-center gap-3 my-0 py-2">
          <div className="flex-1 h-px bg-[var(--color-hairline)]" />
